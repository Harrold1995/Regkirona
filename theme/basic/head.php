    ...
    <div class="inner">
      <ul id="hd_qnb">
        ...
        <li><a href="<?php echo G5_BBS_URL ?>/current_connect.php"
               class="visit">접속자<strong class="visit-num"><?php echo connect(
                'theme/basic'
              ); // 현재 접속자수, 테마의 스킨을 사용하려면 스킨을 theme/basic 과 같이 지정  ?></strong></a>
        </li>
      </ul>
    </div>
  </div>
  <div id="hd_wrapper">
    ...
    <div id="logo">
      <a href="<?php echo G5_URL ?>"><img
          src="<?php echo G5_IMG_URL ?>/logo.png"
    ...
    <div class="hd_sch_wr">
      <fieldset id="hd_sch">
        ...
        <form name="fsearchbox" method="get"
          ...
          <button type="submit" id="sch_submit" value="검색"><i
    ...
    <ul class="hd_login">
      <?php if ($is_member) { ?>
        ...
        <?php if ($is_admin) { ?>
          <li class="tnb_admin"><a
              href="<?php echo correct_goto_url(G5_ADMIN_URL); ?>">관리자</a></li>
        <?php } ?>
      <?php } else { ?>
    ...
    <div class="gnb_wrap">
      <ul id="gnb_1dul">
        <li class="gnb_1dli gnb_mnal">
          <button type="button" class="gnb_menu_btn" title="전체메뉴"><i
              class="fa fa-bars" aria-hidden="true"></i><span
              class="sound_only">전체메뉴열기</span></button>
        </li>
        <?php
        ...
        <li class="gnb_1dli <?php echo $add_class; ?>"
          ...
          foreach ((array)$row['sub'] as $row2) {
            ...
            if ($k == 0) {
              echo '<span class="bg">하위분류</span><div class="gnb_2dul"><ul class="gnb_2dul_box">'
                . PHP_EOL;
            }
            ?>
