        ...
        <fieldset id="login_fs">
            ...
            <div id="login_info">
                <div class="login_if_auto chk_box">
                    ...
                    <label for="login_auto_login"><span></span> RICORDA ID</label>  
                </div>
				<!--<div class="login_if_lpl">
					<a href="<?php echo G5_BBS_URL ?>/register.php" class="join">JOIN</a>
				</div>-->
            </div>
			<div class="login_if_lpl">
               <a href="<?php echo G5_BBS_URL ?>/password_lost.php" target="_blank" id="login_password_lost">Password dimenticata?</a>  
            </div>
        </fieldset> 
        </form>
